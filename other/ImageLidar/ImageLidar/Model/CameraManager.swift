...
class CameraManager: ObservableObject, CaptureDataReceiver {
    ...
    @Published var exposure: Float = 0.01
    @Published var iso: Float = 800.0
    ...
    func startPhotoCapture() {
        var desiredDuration = CMTimeMakeWithSeconds(Float64(self.exposure), preferredTimescale: 600)
        var desiredISO: Float = self.iso
